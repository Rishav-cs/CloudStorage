...
})({"j08D7":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "74d07069b0bb64cb";
"use strict";
...
},{}],"mZk7K":[function(require,module,exports,__globalThis) {
var _appwrite = require("appwrite");
document.addEventListener('DOMContentLoaded', ()=>{
    const client = new (0, _appwrite.Client)().setEndpoint('https://fra.cloud.appwrite.io/v1') // Your Appwrite endpoint
    .setProject('682355d400167120e0f2'); // Your project ID
    ...
    async function checkAuth() {
        ...
        try {
            ...
            if (window.location.pathname.includes('index.html') || window.location.pathname.includes('signup.html')) redirectToDashboard();
        } catch (error) {
    ...
    if (signupBtn) {
        ...
        signupBtn.onclick = async ()=>{
            ...
            try {
                ...
                // Ensure no active session exists before creating a new one
                await ensureNoActiveSession();
                const userId = (0, _appwrite.ID).unique();
...
},{"appwrite":"gDEEN"}]},["j08D7","mZk7K"], "mZk7K", "parcelRequirecf13")

//# sourceMappingURL=CloudStorage.b0bb64cb.js.map
